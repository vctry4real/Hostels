...
$stmt = $conn->prepare("SELECT firstName, lastName, emailid, seater, feespm, middleName, stayfrom, duration, course, level, regno, hostel, roomno, gender, contactno FROM registration WHERE hostel='blocka'");
$stmt->execute();
